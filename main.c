...
void apply_threshold(unsigned char input_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS], unsigned char output_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS]);

//Declaring the array to store the image (unsigned char = unsigned 8 bit)
unsigned char input_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS];
unsigned char outputscalify_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS];
...
int main(int argc, char **argv)
{
  ...
  apply_threshold(outputscalify_image, output_image);
